# The All-new (In) Business Productivity Platform
(In) Business Productivity is a unified enterprise platform that significantly enhances enterprise productivity by automating routine tasks and enabling employees to focus on high-value work. The platform addresses three critical enterprise challenges:
...
(In) Business Productivity is designed to provide a unified and flexible framework for implementing AI capabilities within an enterprise context. It combines pre-built components, customization options, and integration capabilities to address a wide range of business needs while ensuring security and compliance.
...
1. **Access Points**: Users can access (In) Business Productivity through a web-based interface or mobile applications.   
...
3. **AI Agents**:
    ...
    * Pre-built Agents: (In) Business Productivity includes a set of pre-configured AI agents that can be easily customized and integrated into workflows.
...
6. **Development Tools**: 
    ...
    * No-Code Tools: (In) Business Productivity provides no-code tools that allow users to build and customize AI solutions without requiring programming skills.
...
7. **Enterprise Systems**: Common enterprise systems that (In) Business Productivity can integrate with, such as SharePoint, Salesforce, ServiceNow, Enterprise databases, and Email systems.
